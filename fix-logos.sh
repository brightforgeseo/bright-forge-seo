...
cp src/pages/index.astro src/pages/index.astro.bak4

# Replace only the Partners Carousel section with the fixed version
sed -i '' '67,87c\
...
echo "Fixed only the logo section in index.astro!"
