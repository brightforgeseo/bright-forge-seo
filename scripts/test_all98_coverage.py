...
class IntentCoverage(unittest.TestCase):
 def test_distinct_buyer_questions_have_visible_sections(self):
  for page,section,phrase in [('development/index.astro','store-build-scope','Ecommerce web design'),('local-seo-for-google-maps-and-gbp.astro','local-authority','Local links'),('ecommerce-seo-services.astro','store-page-roles','homepage')]:
 ...
 def test_remaining_review_requirements(self):
  ...
  local=(ROOT/'src/pages/local-seo-for-google-maps-and-gbp.astro').read_text()
